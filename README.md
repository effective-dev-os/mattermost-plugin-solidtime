...
- **Кнопка в заголовке канала** — быстрый доступ к таймтрекеру; при активном таймере — виджет STOP + тикающее время
- **Правая боковая панель (RHS)** — форма добавления записи, список по дням, навигация по неделям
